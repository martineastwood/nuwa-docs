...
- Align all pages with the tested matrix: CPython 3.10–3.14, no free-threaded / PyPy / musllinux / Linux aarch64.
- Document `nuwa-build` 0.5.1 extras (`watch`, `notebook`) and `nuwa_sdk@0.4.4` pins.
